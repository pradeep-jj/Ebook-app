...
<body>
						...
						<form action="changepassword.jsp" method="post">
							...
							<div class="mb-3">
								<label class="form-label">New Password</label> <input
									...
									id="exampleInputPassword12" required="required" name="newpass">
								<input type="checkbox" onclick="showPassword2()"><b>
									Show Password</b>
								</button>
							</div>
	...
	if (oldpassword != null && newPass != null) {
		...
		boolean f = dao2.updateSuppassword("suplier@gmail.com", oldpassword, newPass);
		if (f) {
