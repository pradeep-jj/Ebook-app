...
<body style="background-color: #eddde8;">
	...
	<div class="container-fluid p-3 back-img">
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<div class="card">
					<div class="card-body">
						<h4 class="text-center">Supplier Login</h4>
						...
						<form action="sup_login.jsp" method="post">
	...
	if (email != null && password != null) {
		...
		boolean f = dao2.supLogin(email, password);
		if (f) {
			session.setAttribute("supObj", new user());
			response.sendRedirect("suplier/supplierhome.jsp");
		} else {
